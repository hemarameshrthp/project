FusionCharts.ready(function () {
    var stockPriceChart = new FusionCharts({
        ...
        dataSource: {
            "chart": {
                "caption": "Macine Setting-Time Monitor",
                "exportEnabled":"1",
                "exportEnabledAtClientSide":"1",
                "xAxisName": "Time",
                "yAxisName": "Deviation",
                "numberSuffix": "mins",
                "refreshinterval": "5",
       ...
       "events": {
           "initialized": function (evt,args) {
               ...
               var dBRef2= firebase.database().ref('settdiff');
               dBRef2.on('value',function(snap){ hema=snap.val()});


               var dBRef4= firebase.database().ref('settstart');
               dBRef4.on('value',function(snap){ hema1=snap.val()});

               var dBRef6= firebase.database().ref('settstop');
